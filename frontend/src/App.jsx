...
function App() {
  ...
  useEffect(() => {
    fetch('https://api-reservas-medicas.onrender.com/api/especialidades')
      .then(res => res.json())
  ...
  useEffect(() => {
    ...
    fetch(`https://api-reservas-medicas.onrender.com/api/medicos?especialidad_id=${especialidadSeleccionada}`)
      .then(res => res.json())
  ...
  useEffect(() => {
    ...
    fetch(`https://api-reservas-medicas.onrender.com/api/horas-disponibles?fecha=${fecha}&medico_id=${medicoSeleccionado}`)
      .then(res => res.json())
  ...
  const cargarCitasAdmin = () => {
    fetch('https://api-reservas-medicas.onrender.com/api/admin/citas')
      .then(res => res.json())
  ...
  const cancelarCita = async (id) => {
    ...
    try {
      const respuesta = await fetch(`https://api-reservas-medicas.onrender.com/api/admin/citas/${id}`, {
        method: 'DELETE'
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const respuesta = await fetch('https://api-reservas-medicas.onrender.com/api/reservar', {
        method: 'POST',
